...
test.describe('Card Edit Full Flow - E2E', () => {
  ...
  test('should edit card in learn mode and see changes immediately', async ({ page }) => {
    ...
    expect(initialState.qaUserCardsCount).toBeGreaterThan(0);
    expect(initialState.qaUserCardsAdminCount).toBeGreaterThan(0);
    expect(initialState.originalCardExists).toBeTruthy();
