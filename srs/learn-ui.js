import { LearningSession } from './session.js?v=6.23.0';
import { getDueCards, syncFavorite, syncDailyStats, syncWithServer } from './storage.js?v=6.23.0';
import { getProgressMap } from './stats-utils.js?v=6.23.0';
import { checkAchievements } from './stats-utils.js?v=6.23.0';
import { Scheduler } from './scheduler.js?v=6.23.0';
import { getTodaysSession } from './category-scheduler.js?v=6.23.0';
import { getDifficultyLevel, canUseEasy } from './algorithm.js?v=6.23.0';
import { createFormatToolbar, initFormatToolbar } from './format-toolbar.js?v=6.23.0';
import { applyFormatting, createEmptyFormatting, convertHtmlToTextAndFormatting, renderFormattingInEditor } from './text-formatter.js?v=6.23.0';
...
function showStats(stats, results, total) {
    ...
    if (!overlay) {
        ...
        overlay.querySelector('#sum-exit').addEventListener('click', () => {
            ...
            import('./stats-ui.js?v=6.23.0').then(({ initStatsPage }) => {
