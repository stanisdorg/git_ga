...
import { syncFavorite } from './storage.js?v=6.09';
import { getDifficultyLevel, getLevelProgress } from './algorithm.js?v=6.09';
import { getTodaysSession } from './category-scheduler.js?v=6.09';
import { startLearnSession } from './learn-ui.js?v=6.09';
